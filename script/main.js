...
const form = `
<form action="..." method="GET" class="erfgoedkit-widget">
    <div>
        ...
        <div class="erfgoedkit-widget__form-inner">
            <div class="erfgoedkit-widget__form-item">
                <label class="erfgoedkit-widget__label" for="subject">Onderwerp</label>
                <select class="erfgoedkit-widget__input" name="subject" id="subject">
                    <option value="">Kies een Onderwerp</option>
                    <option value="API">Get from API!</option>
                </select>
            ...
            <div class="erfgoedkit-widget__form-item">
                <label class="erfgoedkit-widget__label" for="appearance">Verschijningsvorm</label>
                <select class="erfgoedkit-widget__input" name="appearance" id="appearance">
                    <option value="">Kies een Verschijningsvorm</option>
                    <option value="API">Get from API!</option>
                </select>
                <span class="erfgoedkit-widget__input-icon" aria-hidden="true"><svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg"><path stroke="currentColor" stroke-width="2" d="M4 1l6 6-6 6" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
            </div>
...
const handleResize = (element) => () => {
    ...
    console.log("isLargerSize: ", isLargerSize);
